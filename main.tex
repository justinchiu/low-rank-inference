...
We provide the low-rank hypergraph marginalization algorithms for HMMs and PCFGs in Alg.~\ref{alg:lr-marg-hmm-pcfg}.
The normalizing constants are explicitly computed using the unnormalized low-rank factors for clarity.
